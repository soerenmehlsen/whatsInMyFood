...
const TryNow = ({buttonText = "Try now"}) => {
    ...
    return (
            <button
                onClick={handleClick}
                className="group inline-flex items-center justify-center gap-2 rounded-full bg-zinc-900 px-9 py-3.5 text-lg font-semibold text-white shadow-lg shadow-zinc-900/10 ring-1 ring-zinc-900/5 transition-all duration-200 hover:-translate-y-0.5 hover:bg-zinc-800 hover:shadow-xl hover:shadow-zinc-900/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#34c759] focus-visible:ring-offset-2 active:translate-y-0">
                {buttonText}
                <svg
