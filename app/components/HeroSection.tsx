...
const CheckIcon = () => (
    <svg className="h-4 w-4 flex-none text-accent-fg" viewBox="0 0 20 20" fill="none" aria-hidden="true">
            ...
            <div className="mx-auto max-w-3xl px-4">
                ...
                <Fade delay={250} direction="up">
                    <div className="flex justify-center">
                        <span className="inline-flex items-center gap-2 rounded-full border border-[#34c759]/40 bg-[#34c759]/10 px-4 py-1.5 text-sm font-medium text-accent-fg backdrop-blur">
                ...
                <Fade delay={400} direction="up">
                    <h1 className="mt-6 text-balance text-5xl font-bold tracking-tight text-ink sm:text-6xl">
                        Understand your{" "}
                ...
                <Fade delay={650} direction="up">
                    <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
                        ...
                        <a
                            href="#how-it-works"
                            className="inline-flex items-center justify-center gap-2 rounded-full border border-zinc-200 bg-white/60 px-7 py-3.5 text-lg font-semibold text-zinc-700 backdrop-blur transition-all duration-200 hover:-translate-y-0.5 hover:border-[#34c759]/40 hover:text-accent-fg">
                            See how it works
                        </a>
                    </div>
                </Fade>
